<?php
namespace BootsrapView\Form\View\Helper;
...
class FormRow extends AbstractHelper
{
            ...
            if ($type === 'multi_checkbox'
                ...
                switch ($this->labelPosition) {
                	case self::LABEL_PREPEND:
                	    $markup = '<div class="form-group">' . $labelOpen . $label . $labelClose . ' <div class="col-sm-10">' . $elementString . "</div>" . "</div>";
                	    break;
    ...
    public function getLabelAttributes()
    {
        if( isset( $this->labelAttributes['class'] ) ){
            $this->labelAttributes['class'] .= ' col-sm-2 control-label';
        }else{
            $this->labelAttributes['class'] = ' col-sm-2 control-label';
        }
